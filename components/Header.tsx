  ...
  return (
    <>
      <div className="flex bg-white border-b border-b-gray-200">
        <div className="flex items-center p-5 xl:p-6 border-r-gray-200 border-r">
          <Image src={Menu_Icon} alt="Menu Icon" className="size-7 text-[#9EA3AE] cursor-pointer" />
        </div>
        <div className="flex items-center grow py-5 px-4 xl:p-6">
            ...
            <Sheet>
              ...
              <SheetContent className='w-1/3'>
                ...
                <div className='flex flex-col gap-6 p-4'>
                  ...
                  <Button size='default' className='text-[#192126] text-base bg-[#BBF246] cursor-pointer hover:bg-[#BBF246] focus:bg-[#BBF246] focus-visible:ring-0 active:bg-[#BBF246]'>
                    Upload Post
                  </Button>
                </div>
              </SheetContent>
